...
## Description 
 ...
 ## Folders
 The example masking folder contains 3 sets of example images and code to mask these images. There are 15 images each to mask and the code has already been successfully tested. 
